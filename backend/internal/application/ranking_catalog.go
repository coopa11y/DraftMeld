...
func BuiltInRankingSources() []ranking.SourceDefinition {
	return []ranking.SourceDefinition{
		...
		{ID: "espn-ppr-pdf", Name: "ESPN PPR Top 300 PDF", Description: "Overall PPR rankings imported from a user-supplied ESPN draft-kit PDF.", Methodology: "ESPN overall ordinal rank; QB, RB, WR, and TE only", License: "Proprietary; user-supplied and never redistributed", ProjectURL: espnDraftKitURL, DataURL: espnDraftKitURL, DefaultWeight: 0.9, ImportMode: "pdf-upload"},
		{ID: "espn-dynasty-pdf", Name: "ESPN Dynasty PDF", Description: "Long-term overall rankings imported from a user-supplied ESPN dynasty cheat sheet.", Methodology: "ESPN dynasty overall ordinal rank; QB, RB, WR, and TE only", License: "Proprietary; user-supplied and never redistributed", ProjectURL: espnDraftKitURL, DataURL: espnDraftKitURL, DefaultWeight: 0.6, ImportMode: "pdf-upload"},
	}
}
