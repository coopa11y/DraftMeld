...
func testLeagueConfiguration() league.Configuration {
	return league.Configuration{
		ID: "league-a", Kind: league.ConfigurationKindLeague,
		Rules: league.Rules{
			...
			SourcePreferences: map[string]league.RankingSourcePreference{
