...
export type RankingSourceRecommendation = components["schemas"]["RankingSourceRecommendation"];
export type RankingSourceRecommendations = components["schemas"]["RankingSourceRecommendations"];
...
export type PlayerNewsSource = components["schemas"]["PlayerNewsSource"];
export type AddPlayerNewsSourceRequest = components["schemas"]["AddPlayerNewsSourceRequest"];
export type PlayerAvailability = components["schemas"]["PlayerAvailability"];
export type PlayerNewsEvent = components["schemas"]["PlayerNewsEvent"];
export type PlayerNewsUpdate = components["schemas"]["PlayerNewsUpdate"];
export type PlayerNewsFeed = components["schemas"]["PlayerNewsFeed"];
export type PlayerNewsRefreshResult = components["schemas"]["PlayerNewsRefreshResult"];
